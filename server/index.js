...
// Update Payment
app.put('/api/payments/:id', authenticate, checkDatabaseConnection, async (req, res) => {
  try {
    // Ensure Content-Type is JSON
    res.setHeader('Content-Type', 'application/json');
...
// Delete Payment
app.delete('/api/payments/:id', authenticate, checkDatabaseConnection, async (req, res) => {
  try {
    // Ensure Content-Type is JSON
    res.setHeader('Content-Type', 'application/json');
  ...
  try {
    ...
    if (groupCount === 0) {
      ...
      if (adminGroup) {
        ...
        const requiredPermissions = ['admin', 'dashboard', 'categories', 'sales', 'payments', 'payment-dashboard', 'payment-vouchers', 'payment-voucher-list', 'payment-reports', 'reports', 'branches', 'groups', 'users', 'settings', 'suppliers'];
